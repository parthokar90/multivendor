                    ...
                    <form action="{{route('vendor.profile.update',$vendor->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
                                ...
                                <div class="card mb-3">
                                    <div class="card-header">
                                        <h3><i class="far fa-file-image"></i> Shop Banner </h3>
                                    </div>
                                    <div class="card-body text-center">
                                    <img class="mb-2" src="{{asset('vendor/shop/banner/'.optional($vendor->shops)->shop_banner)}}" width="200" height="200" alt="vendor profile">
                                        <div class="row">
                                            <div class="col-lg-12">
